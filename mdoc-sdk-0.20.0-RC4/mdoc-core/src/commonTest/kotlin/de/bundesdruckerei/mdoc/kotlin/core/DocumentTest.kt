...
class DocumentTest {
    ...
    private val documentBytesWithIncompleteNamespaceItems =
        Data.Document.dataHexWithIncompleteNamespaceItems.hexToByteArray()
    ...
    fun testIsi() {
        val i =
            IssuerSignedItem.fromTaggedBytes(
                "D8185851A468646967657374494419022E6672616E646F6D5016F3AC07BC1CAE62ACB002C67F54015A71656C656D656E744964656E7469666965726B6167655F6F7665725F32316C656C656D656E7456616C7565F5".hexToByteArray()
            )
