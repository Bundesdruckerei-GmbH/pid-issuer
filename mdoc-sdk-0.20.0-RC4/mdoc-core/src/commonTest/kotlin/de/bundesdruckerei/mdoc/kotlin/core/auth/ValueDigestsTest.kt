...
class ValueDigestsTest{
    ...
    @Before
    fun setUp() {
        valueDigestCBOR = CBORObject.DecodeFromBytes(valueDigestByteString.hexToByteArray())
        ValueDigestsTest()
    ...
    @Test
    fun checkDigests() {
        val digestsCBOR: CBORObject = CBORObject.DecodeFromBytes(digestsByteString.hexToByteArray())
