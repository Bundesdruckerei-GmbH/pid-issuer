...
class MacKeyTest
{
    ...
    fun fromCBOR()
    {
        ...
        val salt = CryptoUtils.digestSHA256(sessionTranscriptBytes.hexToByteArray())
        val calculatedMacKey = CryptoUtils.deriveSessionKeyFromSharedSecret(mac_Zab.hexToByteArray(), salt, "EMacKey".toByteArray(StandardCharsets.UTF_8))
