...
public class C1Controller {
    ...
    public C1Controller(C1FlowController flowController, HttpLibraryAdapter httpAdapter) {
    ...
    public ResponseEntity<JsonNode> refreshToken(@RequestHeader MultiValueMap<String,String> allHeaders,  @RequestParam MultiValueMap<String,String> allParams) {
        return authenticationFlow.handleRefreshToken(allHeaders, allParams);
    }
    ...
    public ResponseEntity<JsonNode> issueCredential(@RequestHeader MultiValueMap<String, String> allHeaders,
        ...
        return authenticationFlow.handleCredential(FlowVariant.C1, allHeaders, allParams, body);
    }
}
