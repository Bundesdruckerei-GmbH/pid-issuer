...
import de.bdr.pidi.authorization.core.flows.BFlowController;
...
public class BController {
    ...
    public BController(BFlowController flowController, HttpLibraryAdapter httpAdapter) {
    ...
    * according to that of the Authorization Endpoint of the Authorization Code Flow in OAuth 2.0.
    ...
    public ResponseEntity<JsonNode> issueCredential(@RequestHeader MultiValueMap<String, String> allHeaders,
        ...
        return authenticationFlow.handleCredential(FlowVariant.B, allHeaders, allParams, body);
    }
}
