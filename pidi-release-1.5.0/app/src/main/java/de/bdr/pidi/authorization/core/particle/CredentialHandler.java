...
public class CredentialHandler implements OidHandler {
    ...
    private List<String> buildCredentials(WSession session, CredentialRequest credentialRequest) {
        ...
        return holderBindingKeys.stream().map(k -> buildCredential(credentialRequest, identificationData, k)).toList();
    }

    @SuppressWarnings("unchecked")
    private String buildCredential(CredentialRequest credentialRequest, String identificationData, String holderBindingKey) {
        ...
        try {
            return switch (credentialRequest) {
                ...
                case MsoMdocCredentialRequest msoMdocCredentialRequest ->
                        ((MdocBuilder<MsoMdocCredentialRequest>)mdocBuilder).build(credentialData, msoMdocCredentialRequest, holderBindingKey);
                case MsoMdocAuthChannelCredentialRequest msoMdocAuthChannelCredentialRequest ->
                        ((MdocBuilder<MsoMdocAuthChannelCredentialRequest>)mdocBuilder).build(credentialData, msoMdocAuthChannelCredentialRequest, holderBindingKey);
    ...
    private List<String> buildCredentialsWithoutKeyProof(WSession session, CredentialRequest credentialRequest) {
        ...
        return List.of(buildCredential(credentialRequest, identificationData, holderBindingKey));
    }
