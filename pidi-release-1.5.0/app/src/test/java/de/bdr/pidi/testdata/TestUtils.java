...
public class TestUtils {
    ...
    public static CredentialRequest createSdJwtCredentialRequest(JwtProof proof) {
        return new SdJwtVcCredentialRequest(SdJwtVcCredentialFormat.INSTANCE, proof, Collections.emptyList(), null, PidDataConst.SD_JWT_VCTYPE);
    }

    public static CredentialRequest createSdJwtCredentialRequest(List<Proof> proofs) {
        return new SdJwtVcCredentialRequest(SdJwtVcCredentialFormat.INSTANCE, null, proofs, null, PidDataConst.SD_JWT_VCTYPE);
    }

    public static CredentialRequest createSdJwtAuthChannelCredentialRequest(JwtProof proof) {
        return new SdJwtVcAuthChannelCredentialRequest(SdJwtVcAuthChannelCredentialFormat.INSTANCE, proof, Collections.emptyList(), null, PidDataConst.SD_JWT_VCTYPE, DEVICE_PUBLIC_KEY);
    }
    ...
    public static Map<String, CBORObject> readMdocIssuerAuth(byte[] decodedMDoc) throws IOException {
        ...
        return Map.of("signed", signed, "validFrom", validFrom, "validUntil", validUntil);
    }
