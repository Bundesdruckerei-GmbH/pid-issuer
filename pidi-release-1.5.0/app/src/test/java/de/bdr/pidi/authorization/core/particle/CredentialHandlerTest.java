...
class CredentialHandlerTest {
    ...
    void shouldProcessMdoc() throws ParseException {
        ...
        when(mockedMdocBuilder.build(pidCredentialData, (MsoMdocCredentialRequest) localRequest.getBody(), "credential")).thenReturn("mdoc");
    ...
    void shouldBatchProcessMdoc() throws ParseException {
        ...
        when(mockedMdocBuilder.build(eq(pidCredentialData), eq((MsoMdocCredentialRequest) localRequest.getBody()), anyString())).thenReturn("mdoc1", "mdoc2");
    ...
    void shouldProcessMdocAuthChannel() throws ParseException {
        ...
        when(mockedMdocAuthChannelBuilder.build(pidCredentialData, (MsoMdocAuthChannelCredentialRequest) localRequest.getBody(), null)).thenReturn("mdoc");
