...
class BTokenTest extends RemoteTest {

    public static final FlowVariant FLOW_VARIANT = FlowVariant.B;
    private final Steps steps = new Steps(FLOW_VARIANT);
    @Test
    @DisplayName("Token request happy path, variant b")
    @Requirement({"PIDI-20","PIDI-282"})
    @XrayTest(key = "PIDI-945")
    void test001() {
    ...
    @DisplayName("Token request missing code_verifier, variant b")
    @Test
    @Requirement("PIDI-163")
    @XrayTest(key = "PIDI-928")
    void test002() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request malformed code_verifier, variant b")
    @Test
    @Requirement("PIDI-163")
    @XrayTest(key = "PIDI-915")
    void test003() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request invalid grant, variant b")
    @Test
    @Requirement("PIDI-163")
    @XrayTest(key = "PIDI-903")
    void test004() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request empty grant_type, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-892")
    void test005() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing redirect_uri, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-881")
    void test006() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request malformed redirect_uri, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-868")
    void test007() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing authorization code, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-955")
    void test008() {
    ...
    @DisplayName("Token request malformed authorization code, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-942")
    void test009() {
        TokenRequestBuilder.valid(FLOW_VARIANT, RandomUtil.randomString())
    ...
    @DisplayName("Token request empty authorization code, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-870")
    void test010() {
        TokenRequestBuilder.valid(FLOW_VARIANT, RandomUtil.randomString())
    ...
    @DisplayName("Token request missing content type, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-862")
    void test011() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing referenced session, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-950")
    void test012() {
        TokenRequestBuilder.valid(FLOW_VARIANT, RandomUtil.randomString())
    ...
    @DisplayName("Token request invalid redirect_uri, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-922")
    void test014() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing grant_type, variant b")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-909")
    void test015() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request missing dpop header, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-965")
    void test016() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request empty dpop header, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-968")
    void test017() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, wrong dpop httpMethod, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-972")
    void test018() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, wrong dpop path, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-976")
    void test019() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, JWT not parsable , variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-980")
    void test020() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, multiple dpop header, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-984")
    void test021() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, multiple values in dpop header, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-985")
    void test022() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, dpop jwt fictional / too young, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-992")
    void test023() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, dpop jwt stale / too old, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-993")
    void test024() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, invalid signature, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-1003")
    void test025() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, invalid type, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-1008")
    void test026() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, nonce missing, variant b")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-1017")
    void test027() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
