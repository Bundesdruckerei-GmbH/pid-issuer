...
abstract class MDocCredentialCreator(
    ...
    override fun create(
        ...
        return Credential(Base64.getUrlEncoder().withoutPadding().encodeToString(mdocBytes))
    }

    private fun StatusReference.toStatusClaim() = StatusClaim(StatusListInfo(index.toLong(), uri))
