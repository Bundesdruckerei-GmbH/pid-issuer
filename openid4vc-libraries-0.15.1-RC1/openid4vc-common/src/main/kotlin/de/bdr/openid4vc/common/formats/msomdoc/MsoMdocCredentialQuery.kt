...
@Serializable
data class MsoMdocCredentialQuery(
    @SerialName("id") override val id: String,
    @SerialName("format") override val format: CredentialFormat,
    @SerialName("meta") override val credentialMetaQuery: MsoMdocCredentialMetaQuery? = null,
    ...
    init {
        require(format == MsoMdocCredentialFormat) { "Format must be mdoc" }
