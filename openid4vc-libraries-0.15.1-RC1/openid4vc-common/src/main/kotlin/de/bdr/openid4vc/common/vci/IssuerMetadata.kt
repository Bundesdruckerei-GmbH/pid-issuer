...
data class IssuerMetadata(
    ...
    @Deprecated(
        "removed in OID4VCI Draft Version 14, use credentials array in credential response instead"
    )
...
abstract class CredentialDescription {
    ...
    abstract val proofTypesSupported: Map<ProofType, ProofTypeConfiguration>?
