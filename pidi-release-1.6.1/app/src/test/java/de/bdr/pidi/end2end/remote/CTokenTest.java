...
class CTokenTest extends RemoteTest {
    ...
    @DisplayName("Token request missing code_verifier, variant c")
    @Test
    @Requirement("PIDI-163")
    @XrayTest(key = "PIDI-322")
    void test002() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request malformed code_verifier, variant c")
    @Test
    @Requirement("PIDI-163")
    @XrayTest(key = "PIDI-339")
    void test003() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request invalid grant, variant c")
    @Test
    @Requirement("PIDI-163")
    @XrayTest(key = "PIDI-340")
    void test004() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request empty grant_type, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-561")
    void test005() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing redirect_uri, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-565")
    void test006() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request malformed redirect_uri, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-566")
    void test007() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing authorization code, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-562")
    void test008() {
    ...
    @DisplayName("Token request malformed authorization code, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-563")
    void test009() {
        TokenRequestBuilder.valid(FLOW_VARIANT, RandomUtil.randomString())
    ...
    @DisplayName("Token request empty authorization code, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-564")
    void test010() {
        TokenRequestBuilder.valid(FLOW_VARIANT, RandomUtil.randomString())
    ...
    @DisplayName("Token request missing content type, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-567")
    void test011() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing referenced session, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-568")
    void test012() {
        TokenRequestBuilder.valid(FLOW_VARIANT, RandomUtil.randomString())
    ...
    @DisplayName("Token request invalid redirect_uri, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-570")
    void test014() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request missing grant_type, variant c")
    @Test
    @Requirement("PIDI-20")
    @XrayTest(key = "PIDI-560")
    void test015() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request missing dpop header, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-966")
    void test016() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request empty dpop header, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-969")
    void test017() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, wrong dpop httpMethod, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-970")
    void test018() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, wrong dpop path, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-974")
    void test019() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, JWT not parsable, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-979")
    void test020() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, multiple dpop header, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-982")
    void test021() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, multiple values in dpop header, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-986")
    void test022() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, dpop jwt fictional / too young, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-988")
    void test023() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, dpop jwt stale / too old, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-989")
    void test024() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, invalid signature, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-1002")
    void test025() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, invalid type, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-1009")
    void test026() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @Test
    @DisplayName("Token request, nonce missing, variant c")
    @Requirement("PIDI-227")
    @XrayTest(key = "PIDI-1018")
    void test027() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
    ...
    @DisplayName("Token request session expired, variant c")
    @Requirement({"PIDI-266"})
    @XrayTest(key = "PIDI-2322")
    void test028() {
        var requestUri = steps.doPAR();
        var issuerState = steps.doAuthorize(requestUri);
        var faResponse = steps.doFinishAuthorization(issuerState);
