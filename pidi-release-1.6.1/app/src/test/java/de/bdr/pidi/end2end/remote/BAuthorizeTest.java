...
class BAuthorizeTest extends RemoteTest {
    ...
    @DisplayName("Authorize missing client_id, variant b")
    @Test
    @Requirement({"PIDI-299","PIDI-17"})
    @XrayTest(key = "PIDI-929")
    void test002() {
        String requestUri = steps.doPAR();
        new AuthorizationRequestBuilder("/b/authorize")
                .withRequestUri(requestUri)
    ...
    @DisplayName("Authorize missing request_uri, variant b")
    @Test
    @Requirement({"PIDI-299","PIDI-17"})
    @XrayTest(key = "PIDI-872")
    void test003() {
        new AuthorizationRequestBuilder("/b/authorize")
                .withClientId(ClientIds.validClientId().toString())
                .doRequest()
    ...
    @DisplayName("Authorize malformed request_uri, variant b")
    @Test
    @Requirement({"PIDI-299","PIDI-17"})
    @XrayTest(key = "PIDI-857")
    void test004() {
        new AuthorizationRequestBuilder("/b/authorize")
                .withClientId(ClientIds.validClientId().toString())
    ...
    @DisplayName("Authorize malformed client_id, variant b")
    @Test
    @Requirement({"PIDI-299","PIDI-17"})
    @XrayTest(key = "PIDI-893")
    void test005() {
        String requestUri = steps.doPAR();
        new AuthorizationRequestBuilder("/b/authorize")
                .withClientId("123456")
    ...
    @DisplayName("Authorize empty client_id, variant b")
    @Test
    @Requirement({"PIDI-299","PIDI-17"})
    @XrayTest(key = "PIDI-882")
    void test006() {
        String requestUri = steps.doPAR();
        new AuthorizationRequestBuilder("/b/authorize")
                .withClientId("")
    ...
    @DisplayName("Authorize request_uri do not references an existing session, variant b")
    @Test
    @Requirement({"PIDI-299","PIDI-17"})
    @XrayTest(key = "PIDI-917")
    void test007() {
        new AuthorizationRequestBuilder("/b/authorize")
                .withClientId(ClientIds.validClientId().toString())
