...
data class MobileSecurityObject(
    ...
    fun asTaggedCBOR(): CBORObject = CBORObject.FromObject(asCBOR().EncodeToBytes()).WithTag(
        CBOR_TAG_BYTE_STRING
    )
    ...
    companion object {
        ...
        private val cborMapper = CBORTypeMapper().AddConverter(MobileSecurityObject::class.java, CborConverter)
