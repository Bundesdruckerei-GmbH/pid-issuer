...
class ReaderAuthTest {
    ...
    fun setUp() {
        ...
        readerCertificate = CertUtils.decodeCertificates(readerCertificateByteString.toByteArray()).certificates[0] as X509Certificate
        readerCertificateDS = CertUtils.decodeCertificates(readerCertificateDSByteString.toByteArray()).certificates[0] as X509Certificate
    ...
    @Test
    fun asCBOR() {
        val cbor = CBORObject.DecodeFromBytes(readerAuthExpectedByteString.toByteArray())
