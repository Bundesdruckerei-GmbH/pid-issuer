...
class DeviceKeyInfoTest {
    ...
    private val deviceKeyInfoWithoutOptionalCBOR = CBORObject.DecodeFromBytes(deviceKeyInfoByteStringWithoutOptional.toByteArray())
    ...
    @Before
    fun setUp() {
        deviceKeyInfoCBOR = CBORObject.DecodeFromBytes(deviceKeyInfoByteString.toByteArray())

        keyAuthorizationsCBOR = CBORObject.DecodeFromBytes(keyAuthorizationsByteString.toByteArray())
        keyAuthorizations = KeyAuthorizations.fromCBOR(keyAuthorizationsCBOR)

        deviceKeyCBOR = CBORObject.DecodeFromBytes(deviceKeyByteString.toByteArray())
