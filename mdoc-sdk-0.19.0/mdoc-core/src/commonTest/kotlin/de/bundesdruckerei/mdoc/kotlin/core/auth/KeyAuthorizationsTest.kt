...
class KeyAuthorizationsTest {
    ...
    fun setUp() {
        ...
        keyAuthorizationsWithOnlyNameSpacesByteStringCBOR = CBORObject.DecodeFromBytes(keyAuthorizationsWithOnlyNameSpacesByteString.toByteArray())
        keyAuthorizationsWithOnlyDataElementsByteStringCBOR = CBORObject.DecodeFromBytes(keyAuthorizationsWithOnlyDataElementsByteString.toByteArray())
